...
export const PRODUCTS: Product[] = [
    ...
    {
        id: '5',
        name: 'CP Revolution Tee - Black',
        title: 'CP REVOLUTION TEE — BLACK',
        price: 129,
        frontImage: '/images/products/noir/revolution-tee-black.webp',
        backImage: '/images/products/noir/revolution-tee-black.webp',
        image: '/images/products/noir/revolution-tee-black.webp',
        stripeLink: '',
        status: 'NEW RELEASE',
        category: 'Tops',
    },
    {
        id: '6',
        name: 'CP Revolution Tee - White',
        title: 'CP REVOLUTION TEE — WHITE',
        price: 129,
        frontImage: '/images/products/noir/revolution-tee-white.webp',
        backImage: '/images/products/noir/revolution-tee-white.webp',
        image: '/images/products/noir/revolution-tee-white.webp',
        stripeLink: '',
        status: 'NEW RELEASE',
        category: 'Tops',
    },
