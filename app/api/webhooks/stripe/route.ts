...
<head>
  ...
  <style>
    ...
    .accent { color: #CC7722; }
    .badge { display: inline-block; background: #CC7722; color: #000; font-size: 11px; font-weight: 700; padding: 4px 10px; text-transform: uppercase; letter-spacing: 0.1em; margin-bottom: 24px; }
    ...
    .amount { font-size: 28px; font-weight: 900; color: #CC7722; }
...
<body>
  <div class="container">
    ...
    <div class="section">
      ...
      ${size !== 'N/A' ? `<div style="margin-top:8px;"><span class="label">Size: </span><span style="color:#CC7722;font-size:13px;">${size}</span></div>` : ''}
    </div>
